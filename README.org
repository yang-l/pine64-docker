...
make build
make binary
tar cJhvf docker.tar.xz --xform='s,bundles/1.13.0/binary-client,.,g;s,bundles/1.13.0/binary-daemon,.,g' bundles/1.13.0/binary-client/docker bundles/1.13.0/binary-daemon/docker-containerd bundles/1.13.0/binary-daemon/docker-containerd-ctr bundles/1.13.0/binary-daemon/docker-containerd-shim bundles/1.13.0/binary-daemon/dockerd bundles/1.13.0/binary-daemon/docker-init bundles/1.13.0/binary-daemon/docker-proxy bundles/1.13.0/binary-daemon/docker-runc
#+END_SRC
